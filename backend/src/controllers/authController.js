...
exports.login = async (req, res) => {
  try {
    ...
    console.log("🧪 compare กับ DB:", await bcrypt.compare('123456', user.password))
...
console.log("🔍 password charCodes:", [...password].map(c => c.charCodeAt(0)))
    } else {
...
exports.register = async (req, res) => {
  try {
    const { full_name, email, password, role = 'user', department = '' } = req.body
